{
  programs.plasma = {
    enable = true;
    shortcuts = {
      ActivityManager.switch-to-activity-b99287b4-f85a-4cf7-8ba4-03d88ecf5a59 = [ ];
    ...
    configFile = {
      ...
      dolphinrc.General.ViewPropsTimestamp = "2026,3,31,17,34,21.222";
      dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
      dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
      dolphinrc.PreviewSettings.Plugins = "windowsimagethumbnail,djvuthumbnail,svgthumbnail,imagethumbnail,audiothumbnail,exrthumbnail,kraorathumbnail,windowsexethumbnail,jpegthumbnail,ebookthumbnail,opendocumentthumbnail,comicbookthumbnail,cursorthumbnail,appimagethumbnail,directorythumbnail,fontthumbnail,ffmpegthumbs,rawthumbnail,mobithumbnail,blenderthumbnail,gsthumbnail";
      kactivitymanagerdrc.activities.b99287b4-f85a-4cf7-8ba4-03d88ecf5a59 = "Default";

      # Configure Kate
      # Generated using rc2nix, quoted text can be changed to options in plasma-manager
      katerc = {
        General = {
          "Days Meta Infos" = 30;
          PinnedDocuments = "";
      ...
      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".Image = "/home/sphalerite-system/Downloads/nixos-wallpaper-catppuccin-mocha.png";

      kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".PreviewImage = "/home/sphalerite-system/Downloads/nixos-wallpaper-catppuccin-mocha.png";

      ktrashrc."\\/home\\/sphalerite-system\\/.local\\/share\\/Trash".Days = 7;
      ktrashrc."\\/home\\/sphalerite-system\\/.local\\/share\\/Trash".LimitReachedAction = 0;
      ktrashrc."\\/home\\/sphalerite-system\\/.local\\/share\\/Trash".Percent = 10;
      ktrashrc."\\/home\\/sphalerite-system\\/.local\\/share\\/Trash".UseSizeLimit = true;
      ktrashrc."\\/home\\/sphalerite-system\\/.local\\/share\\/Trash".UseTimeLimit = false;

      kwinrc.Desktops.Id_1 = "38bc0cd5-19c8-49fe-a693-9c600ba8e50c";
      kwinrc.Desktops.Number = 1;
      kwinrc.Desktops.Rows = 1;
      kwinrc.Plugins.krohnkiteEnabled = true;
      kwinrc.Script-krohnkite.preventProtrusion = false;
      kwinrc."Tiling/38bc0cd5-19c8-49fe-a693-9c600ba8e50c/79f3b022-cea8-4502-acd1-fca1b70579c3".padding = 4;
      kwinrc."Tiling/38bc0cd5-19c8-49fe-a693-9c600ba8e50c/79f3b022-cea8-4502-acd1-fca1b70579c3".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
